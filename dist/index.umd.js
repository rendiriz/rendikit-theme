(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['rendikit-theme'] = {}));
    ...
    const color = [
        ...
        // Gray
        { code: 'N', normal: '#212121', bootstrap: 'gray' },
        { code: 'N50', normal: '#FAFAFA', bootstrap: 'gray-50' },
        { code: 'N100', normal: '#F5F5F5', bootstrap: 'gray-100' },
        { code: 'N200', normal: '#EEEEEE', bootstrap: 'gray-200' },
        { code: 'N300', normal: '#E0E0E0', bootstrap: 'gray-300' },
        { code: 'N400', normal: '#BDBDBD', bootstrap: 'gray-400' },
        { code: 'N500', normal: '#9E9E9E', bootstrap: 'gray-500' },
        { code: 'N600', normal: '#757575', bootstrap: 'gray-600' },
        { code: 'N700', normal: '#616161', bootstrap: 'gray-700' },
        { code: 'N800', normal: '#424242', bootstrap: 'gray-800' },
        { code: 'N900', normal: '#212121', bootstrap: 'gray-900' },
        // Blue Gray
        { code: 'DN', normal: '#001B3D', bootstrap: 'blue-gray' },
        { code: 'DN50', normal: '#E3E7ED', bootstrap: 'blue-gray-50' },
        { code: 'DN100', normal: '#B9C3D3', bootstrap: 'blue-gray-100' },
        { code: 'DN200', normal: '#8D9DB5', bootstrap: 'blue-gray-200' },
        { code: 'DN300', normal: '#627798', bootstrap: 'blue-gray-300' },
        { code: 'DN400', normal: '#415C84', bootstrap: 'blue-gray-400' },
        { code: 'DN500', normal: '#1A4373', bootstrap: 'blue-gray-500' },
        { code: 'DN600', normal: '#133C6B', bootstrap: 'blue-gray-600' },
        { code: 'DN700', normal: '#083461', bootstrap: 'blue-gray-700' },
        { code: 'DN800', normal: '#022B55', bootstrap: 'blue-gray-800' },
        { code: 'DN900', normal: '#001B3D', bootstrap: 'blue-gray-900' },
    ];
    function codeConvert(type, code) {
